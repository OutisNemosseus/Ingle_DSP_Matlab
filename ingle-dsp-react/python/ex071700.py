...
Hrs = [np.zeros(1,5),T1,T2,np.ones(1,7),T2,T1,np.zeros(1,9),T1,T2,np.ones(1,7),T2,T1,np.zeros(1,4)]
...
plt.plt.axis([0,1,-0.1,1.1]); plt.title('Bandpass, M=40,T1=0.5941, T2=0.109')
